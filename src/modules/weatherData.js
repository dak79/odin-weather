...
export async function weatherData(location) {
  ...
  const capitalizeDescription = locationDescription.charAt(0).toUpperCase() + locationDescription.slice(1)
  description.textContent = `${capitalizeDescription}. Temperature feels like ${Math.round(location.main.feels_like)} \u00B0C`
